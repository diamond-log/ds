...
} & (React.PropsWithChildren<React.DetailedHTMLProps<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>> & Omit<IntlProps, "intltextposition"> & DSControlProps);
