...
exports.Control = (0, react_1.forwardRef)((props, ref) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: wrapperStyle, children: [(0, jsx_runtime_1.jsx)("input", { ...inputProps, className: inputProps.className, style: controlStyle, ref: ref }), icon &&
