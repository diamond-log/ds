...
exports.Textarea = (0, react_1.forwardRef)(({ dictionary, as, labelId, labelClassName, autoResize, ...props }, ref) => {
    ...
    if (labelId)
        return ((0, jsx_runtime_1.jsxs)("div", { className: "w-100 d-flex flex-column gap-1 p-0", children: [(0, jsx_runtime_1.jsx)("label", { htmlFor: props.id, className: labelClassName + (props?.required ? ' isRequired' : ''), children: dictionary?.[(0, idToIndex_1.idToIndex)(labelId)] || '' }), TextareaElement, (0, jsx_runtime_1.jsx)(ErrorMessage, {})] }));
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [TextareaElement, (0, jsx_runtime_1.jsx)(ErrorMessage, {})] }));
});
